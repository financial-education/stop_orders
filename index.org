...
You might think this order type is redundant--why not just use limit orders?  Consider the limit sell and stop sell:
...
Let's revisit the first example, you own 100 XOM and want to sell if the price falls from $80 to $70 per share.
